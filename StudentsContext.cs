...
{
    public DbSet<Course> Categorias {get;set;}
    ...
    {
        List<Course> categoriasInit = new List<Course>();
        categoriasInit.Add(new Course() { CategoriaId = Guid.Parse("fe2de405-c38e-4c90-ac52-da0540dfb4ef"), Nombre = "Actividades pendientes", Peso = 20});
        categoriasInit.Add(new Course() { CategoriaId = Guid.Parse("fe2de405-c38e-4c90-ac52-da0540dfb402"), Nombre = "Actividades personales", Peso = 50});


        modelBuilder.Entity<Course>(categoria=> 
        {
